...
def drawBoard(size):
    ...
    board = np.ones((int(size), int(size), 3))
...
def main():
    ...
    redPiece = createPiece("red")
    enterRow = int(input("Enter a row to move the piece to: "))
    enterCol = int(input("Enter a column to move the piece to: "))
    movePiece(boardSize, redPiece, enterRow, enterCol)
